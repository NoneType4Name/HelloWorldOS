...
[org 7c00h]
[bits 16]
message_real_mode db 'Hello World OS.'
mov ah, 00h; change video mode.
mov al, 02h; Graphic mode 80x25.
int 10h; run.
...
[bits 32]
message_protected_mode db 'Loaded into protect mode.',0
main:
...
%include 'loader/GDTsettings.asm'
%include 'loader/print.asm'
%include 'loader/switchToProtect.asm'
